...
import img from "../../assets/imagens/slideTechDay.png"
...
const Event: React.FC = () => {
  ...
  <div className='flex-1 flex flex-col justify-center items-center sm:items-end text-center sm:text-right '>
    ...
    <a href="https://www.sympla.com.br/evento/turmalinas-tech-day-3-edicao/3081081" target="_blank" rel="noopener noreferrer">
